...
export const ChatIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a1.125 1.125 0 0 1-1.59 0l-3.72-3.72h-3.562c-1.136 0-2.1-.847-2.193-1.98l-.007-.007v-4.286c0-.97.616-1.813 1.5-2.097m6.75-3.686a6.723 6.723 0 0 1 2.25 1.661m-6.75 0a6.723 6.723 0 0 0-2.25 1.661m6.75 0c.413 1.06.636 2.206.636 3.386m-6.75 0c-.223 1.18-.002 2.326.636 3.386m-3.235 2.814A6.723 6.723 0 0 1 3 12.75m11.25 0c0 .908-.188 1.78-.52 2.576" />
    </svg>
);
